...
3. Download project from github(https://github.com/varunsardana004/Blood-Bank-And-Donation-Management-System.git).
   ...
   OR follow gitbash commands <br>
     ```t
         i>cd C:\\xampp\htdocs\
        ii>git clone https://github.com/varunsardana004/Blood-Bank-Management-System.git
...
<br><b>1. Home Page 
   ...
   <img src="https://user-images.githubusercontent.com/54537819/PICHA04.jpg">
   <br>
   <br>
   5. Need Blood Page
